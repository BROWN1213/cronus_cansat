...
void updateturnaround(){
  ...
  Serial.print(F("velocity_air="));
  Serial.println(velocity_air);
  Serial.print(F("velocity_fall="));
  Serial.println(velocity_fall);
  Serial.print(F("height="));
  Serial.println(height);
  Serial.print(F("estimate_landing_point="));
  Serial.println(estimate_landing_point);
  Serial.print(F("distance_delta="));
  ...
  if(distance_delta>TH_DISTANCE_MIN){
    ...
    Serial.print(F("threshold_height="));
    ...
    if(height>th_height){
      ...
      Serial.print(F("turnaround_angle="));
      Serial.println(turnaround_angle);
      Serial.print(F("turnaround_time="));
      ...
      if(is_turnaround_started==false){
        if(turnaround_permission==true){
          ...
          Serial.println(F("Cansat Turn Around!"));
...
void turnaroundtimeout(){
  Serial.println(F("Cansat Turnaround end"));
